package de.fraunhofer.iem.secucheck.specificationsWithEntryPoints.CWE79;
...
public class CrossSiteScripting_Spec implements FluentTQLUserInterface {
    ...
    public List<FluentTQLSpecification> getFluentTQLSpecification() {
        TaintFlowQuery myTF = new TaintFlowQueryBuilder("CWE79_CrossSiteScripting_WithEntryPoints")
