package de.fraunhofer.iem.secucheck.specificationsWithEntryPoints.CWE89;
...
public class SqlInjection_Spec implements FluentTQLUserInterface {
     ...
     * Entry Points
     */
    String methodEntryPointName1 = "de.fraunhofer.iem.secucheck.todolist.controllers.DatabaseController: "
    		+ "java.lang.String "
    		+ "showTasks "
    		+ "(org.springframework.ui.Model, "
    		+ "java.lang.String)";
    ...
    String methodEntryPointName2 = "de.fraunhofer.iem.secucheck.todolist.controllers.DatabaseController: "
    		+ "java.lang.String "
    		+ "showUrgentTasks "
    		+ "(org.springframework.ui.Model, "
    		+ "java.lang.String)";
    ...
    public List<EntryPoint> entryPoints = Arrays.asList(entryPoint1, entryPoint2);
    ...
    public List<FluentTQLSpecification> getFluentTQLSpecification() {
        TaintFlowQuery myTF = new TaintFlowQueryBuilder("CWE89_SqlInjection_TF1_WithEntryPoints")
        ...
        TaintFlowQuery myTF2 = new TaintFlowQueryBuilder("CWE89_SqlInjection_TF2_WithEntryPoints")
        		.atOnlyDSLEntryPoints(entryPoints)
        		.from(sourceMethod2)
                .to(sinkMethod)
        ...
        TaintFlowQuery myTF3 = new TaintFlowQueryBuilder("CWE89_SqlInjection_TF3_WithEntryPoints")
        		.atOnlyDSLEntryPoints(entryPoints)
        		.from(sourceMethod2)
                .to(sinkMethod2)
                .report("CWE-89 detected: 'SQL Injection' from untrusted value 'String shortname'")
