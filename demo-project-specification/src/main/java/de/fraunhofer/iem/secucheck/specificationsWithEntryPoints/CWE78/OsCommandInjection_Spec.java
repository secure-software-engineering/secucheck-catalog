package de.fraunhofer.iem.secucheck.specificationsWithEntryPoints.CWE78;
...
public class OsCommandInjection_Spec implements FluentTQLUserInterface {
    ...
    public List<FluentTQLSpecification> getFluentTQLSpecification() {
        TaintFlowQuery myTF = new TaintFlowQueryBuilder("CWE78_OsCommandInjection_TF1_WithEntryPoints")
        ...
        TaintFlowQuery myTF2 = new TaintFlowQueryBuilder("CWE78_OsCommandInjection_TF2_WithEntryPoints")
                .atOnlyDSLEntryPoints(entryPoints)
        		.from(sourceMethod)
                .notThrough(sanitizerMethod)
                .to(sinkMethod2)
