package de.fraunhofer.iem.secucheck.specificationsWithEntryPoints.CWE311;
...
public class MissingEncryption_Spec implements FluentTQLUserInterface {
    ...
    public List<FluentTQLSpecification> getFluentTQLSpecification() {
        TaintFlowQuery myTF = new TaintFlowQueryBuilder("CWE311_MissingEncryption_WithEntryPoints")
