...
public class PathTraversalAttackSpec implements FluentTQLUserInterface {
    ...
    public Method sanitizer = new MethodSelector(
            "de.fraunhofer.iem.secucheck.InternalFluentTQL.catalog.PathTraversalAttack.CWE22.PathTraversal: java.lang.String sanitizeForPATH(java.lang.String)",
            "CWE-22"
    );
     ...
     */
    @InFlowParam(parameterID = {0})
    public Method sink1 = new MethodSelector(
     ...
     */
    @InFlowParam(parameterID = {0})
    public Method sink2 = new MethodSelector(
